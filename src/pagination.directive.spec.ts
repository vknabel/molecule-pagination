  ...
  template: `
    <div
      *molPagination="
        itemsForPage;
        let items;
        ifLoading: paginationLoading;
        ifEmpty: paginationEmpty;
        loadNext: loadNext
      "
    >
      <p *ngFor="let item of items" testContent>{{ item }}</p>
    </div>
    <ng-template #paginationEmpty> <p testEmpty>empty</p> </ng-template>
    <ng-template #paginationLoading> <p testLoading>loading</p> </ng-template>
  `
})
...
describe('pagination component', () => {
  ...
  beforeEach(() => {
    hostFixture = TestBed.createComponent<PaginationHostComponent<number>>(
  ...
  it('displays content when stable and having two pages', async(() => {
  ...
  it('displays content when stable and having one page', async(() => {
  ...
  it('displays empty when stable and empty', async(() => {
  ...
  it('displays loading when never emitted', async(() => {
  ...
  it('displays empty when only completing', async(() => {
  ...
  it('picks the latest page loader', async(() => {
    host.itemsForPage = (page, forceReload) => of([1, 2, 3]);
    hostFixture.detectChanges();
  ...
  it('ignores previous page loader', async(() => {
    host.itemsForPage = (page, forceReload) => of([1, 2, 3]);
    hostFixture.detectChanges();
    host.itemsForPage = (page, forceReload) => never();
    hostFixture.detectChanges();
  ...
  it('changing the page loader starts loading', async(() => {
    host.itemsForPage = (page, forceReload) => of([1, 2, 3]);
    hostFixture.detectChanges();
    host.itemsForPage = (page, forceReload) => never();
    hostFixture.detectChanges();
